...
function App() {
  return (
    <div className="antialiased min-h-screen">
      {/* Top Navigation */}
      <header className="w-full sticky top-0 z-40 bg-background shadow-[0px_4px_8px_rgba(0,0,0,0.04)]">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <button className="text-on-surface-variant hover:opacity-80 transition-opacity p-2 rounded-full hover:shadow-neo-pressed">
              <span className="material-symbols-outlined">help_outline</span>
            </button>
            <button className="bg-primary text-on-primary font-semibold py-2 px-6 rounded-full shadow-neo-raised hover:shadow-neo-pressed hover:bg-surface hover:text-primary transition-all duration-300">
              Donasi QRIS
            </button>
          </div>
        </div>
